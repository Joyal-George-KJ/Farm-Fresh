      ...
      <a class="navbar-brand" href="#index.html">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav ml-auto">
            ...
            <!-- <li class="nav-item">
              <a class="nav-link" href="Farmer.php">User</a>
            </li> -->

            <!-- <li class="nav-item">
              <a class="nav-link" href="Investor.php">Investors</a>
            </li>-->
        ...
        <div class="d-lg-block d-none">
          <a href="Login.php" class="btn btn-style btn-secondary ml-lg-3">Login</a>
        </div>
