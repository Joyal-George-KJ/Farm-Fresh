...
<div class="contact-form py-5" id="contact">
  <div class="container py-lg-5 py-md-4">
    <center>
      <h3 class="hny-title mb-lg-5 mb-4">Seller Registration</h3>
...
if (isset($_REQUEST['register'])) {
  ...
  if ($fetchData['cnt'] > 0) {
    ...
    $qryReg = "INSERT INTO `seller`(`sname`,`semail`,`saddress`,`sphone`,`slicence`)VALUES('$Name','$Email','$Address','$Phone','$Licence')";
    $qryLog = "INSERT INTO `login`(`reg_id`, `email`, `password`, `type`) VALUES((select max(`sid`) from `seller`), '$Email', '$Password', 'SELLER')";
