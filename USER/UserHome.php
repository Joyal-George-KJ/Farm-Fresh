    ...
    <header id="site-header" class="fixed-top">
        <div class="container">
            <nav class="navbar navbar-expand-lg stroke">
                <h1><a class="navbar-brand mr-lg-5" href="UserHome.php">
          ...
          <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="ViewHistory.php">History</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="AddProduct.php">Add Product</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="ViewBooking.php">Bookings</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="d-lg-block d-none">
                    <a href="../Login.php" class="btn btn-style btn-secondary ml-lg-3">LogOut</a>
                </div>
                ...
                <div class="col-lg-9 col-md-10 ml-auto">
                    <div class="subscribe ml-auto">
                        ...
                        <form action="#" method="post" class="subscribe-wthree pt-lg-3 mt-4">
                            ...
                            <p class="mt-3">By Subscribing this form, you agree to the <a href="#">privacy policy</a> and <a href="#">terms of use</a></p>
                        </form>
    ...
    <section class="w3l-footer-29-main w3l-copyright">
        <div class="container">
            <div class="bottom-copies">
                <p class="copy-footer-29 text-center">© 2020 Agricfarm. All rights reserved. Design by <a href="https://w3layouts.com/" target="_blank">
                        W3Layouts</a></p>
            </div>
        </div>
